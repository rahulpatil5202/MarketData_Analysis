...
row{data-height=650}
----------------------
### Top performers combined (ST & LT)


```{r}
d360_top20 <- top_n(trend_data, 20, wt = trend_data$d360_prct)
d60_top20 <- top_n(trend_data, 20, wt = trend_data$d60_prct)

recommended_stocks = d360_top20[d360_top20$symbol %in% d60_top20$symbol,]

datatable(recommended_stocks, caption = "Top performers recommended",
          rownames = T,
          filter = "top",
          options = list(pageLength = 100))
