...
## Let's first download NSE Bhavcopies from BSE India
...
NSE_Indices_Days <- seq(as.Date("2018-01-01"),as.Date("2018-05-28"),"days")
...
BSE_Bhavdays <- seq(as.Date("2013-01-01"),as.Date("2018-05-28"),"days")
